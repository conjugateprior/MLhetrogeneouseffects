...
W.forest = regression_forest(X_baseline, W_treatment, clusters = C_vars)
...
#result is the 95% confidence interval in ATE: ___ +/- ___
...
causalforests_IGA_train <- causal_forest(X = X_vars,
                                    ...
                                    tune.parameters = TRUE)# paper clusters
